...
typedef enum _MV_CAM_TRIGGER_ACTIVATION_
{
	MV_TRIGGER_RISINGEDGE = 0,
	MV_TRIGGER_FALLINGEDGE = 1,
	MV_TRIGGER_LEVELHIGH = 2,
	MV_TRIGGER_LEVELLOW = 3,
}MV_CAM_TRIGGER_ACTIVATION;

typedef enum _MV_CAM_VIRTUAL_INPUT_
{
	MONOBAR = 11,
	CHECKBOARD = 13,
	OBLIQUEMONOBAR = 14,
	GRADUALMONOBAR = 16,
}MV_CAM_VIRTUAL_INPUT;
